...
function play(){
    ...
    if(GameStatus == Status.start) {
        ...
        canvas.onclick = function(event){
            ...
            GRAVITY = 2;
            elementSort();
            alert("Hey,Kids. We welcome you here to play the game of atomic table. Here you have to click on the correct symbol of the element. The name of the element is displayed on the left side of the screen.\n")
